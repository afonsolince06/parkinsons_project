...
# ──────────────────────────────────────────────────────────────────────────────
# TEMPLATE DE INTEGRAÇÃO NO PROJETO
# ──────────────────────────────────────────────────────────────────────────────
...
def _template_integration():
    ...
    # ── Importações do projeto (ajustar o caminho conforme necessário) ────────
    # from your_project_module import fitness_function, n_params
    ...
    # ── Executar o DE ─────────────────────────────────────────────────────────
    # best_weights, best_score, convergence = differential_evolution(
    #     fitness_func = fitness_function,
    #     n_params     = n_params,
    #     **DE_CONFIG,
    # )

    # ── Usar os melhores pesos na rede neuronal ───────────────────────────────
    # Depois de obter best_weights, carregá-los no modelo:
    #
    # from your_project_module import set_weights_in_mlp, mlp_model
    # set_weights_in_mlp(mlp_model, best_weights)
